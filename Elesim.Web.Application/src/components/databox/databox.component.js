            ...
            <div>
                            ...
                            <List.Item >
                                <Card
                                    ...
                                    actions={[
                                        ...
                                        />,
                                        <Icon type="star" style={{ fontSize: 16 }} onClick={this.props.onStarClick} />,
                ...
                >
                    <div className="payModal">
                        <h3>
                            {this.props.description ?
                                (<div> شما قصد خرید <span>{this.state.selectedProduct.Title}</span> را دارید <Icon type="info-circle" style={{ fontSize: 24, verticalAlign: "middle" }} /></div>) :
