...
namespace Elesim.Droid.Code.UI
{
    ...
    [Activity(Label = "پکها", Theme = "@style/AppTheme.NoActionBar")]
    public class PackListActivity : BaseActivity
    {
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            ...
            switch (item.ItemId)
            {
                ...
                case Resource.Id.action_search:
                    StartActivity(typeof(SearchPackActivity));
                    break;
        ...
        private async void LoadMore()
        {
            try
            {
                ...
                var list = await Facade.GetPacks(lastLoadedId);
                if (list.Any())
